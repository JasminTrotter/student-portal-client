						...
						<div className="product-select-input">
							<label>
								<input
									...
									label="8 Classes - $120"
									value={120}
									onChange={() => this.setState({ value: 12000, dollarAmount: '120', classAmount: '8 classes' })}
								/>
								8 Classes - $120</label>
						</div>
						...
						<div className="product-select-input">
							<label>
								<input
									...
									label="2 Classes - $32"
									value={32}
									onChange={() => this.setState({ value: 3200, dollarAmount: '32', classAmount: '2 classes' })}
						...
						<div className="product-select-input">
							<label>
								<input
									...
									label="1 Class - $18"
									value={18}
									onChange={() => this.setState({ value: 1800, dollarAmount: '18', classAmount: '1 class' })}
								/>
								1 Class - $18</label>
						</div>
...
export default connect(store)(ProductSelectForm);
